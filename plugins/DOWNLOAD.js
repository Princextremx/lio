...
async (conn, mek, m, { from, args, q, reply }) => {
    try {
        ...
        reply("*_MINI-BOT DOWNLOADING TIKTOK VIDEO , PLEASE WAIT...🚀_*");
        ...
        const caption = `🎵 *MINI-BOT TIKTOK VIDEO* 🎵\n\n` +
                        `👤 *USER:* ${author.nickname} (@${author.username})\n` +
                        `📖 *TITLE:* ${title}\n` +
                        `👍 *LIKES:* ${like}\n💬 *COMMENTS:* ${comment}\n🔁 *SHARES:* ${share}\n\n> *© POWERED BY PRINCE XTREME ♥️*`;
  ...
  try {
    ...
    for (let _0x2c5a94 = 0x0; _0x2c5a94 < 0x14; _0x2c5a94++) {
      ...
      await _0x386562.sendMessage(_0x2b1245, {
        ...
        'mimetype': "video/mp4",
        'caption': "*© POWERED BY PRINCE XTREME INC*"
      }, {
        'quoted': _0x1b4817
      });
      _0x2d5654.react('✅');
