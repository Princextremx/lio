...
cmd(
  ...
  async (robin, mek, m, { from, args, reply }) => {
    try {
      ...
      const desc = `
*𖹭.╭╭ִ╼࣪━ִﮩ٨ـﮩ♡̫𝐌𝐈𝐍𝐈-𝐁𝐎𝐓𖦹ׅ♡ִ̫ﮩ٨ـﮩ━ִ╾࣪╮╮.𖹭*
> ♡ *Title:* ${info.title}
...
cmd({
    ...
    try {
        ...
        let info = `🍄 *𝚂𝙾𝙽𝙶 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙴𝚁* 🍄\n\n` +
            ...
            `1 *Audio Type* 🎵\n` +
            `2 *Document Type* 📁\n\n` +
            `${settings.FOOTER || "> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴘʀɪɴᴄᴇ xᴛʀᴇᴍᴇ*"}`;
...
const yt = await ytsearch(q);
    ...
    let ytmsg = `
*𖹭.╭╭ִ╼࣪━ִ♡𝐌𝐈𝐍𝐈-̫𝐁𝐎𝐓𖦹ׅ♡ִ̫ﮩ٨ـﮩ━ִ╾࣪╮╮.𖹭*
> ♡ *Title:* ${info.title}
*°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°*
> ♡ *Uploaded:* ${info.timestamp} (${info.ago})
*°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°*
...
cmd({ 
    ...
    contextInfo: {
        externalAdReply: {
            ...
            mediaUrl: 'https://whatsapp.com/channel/0029Vb6D2xV8kyyHNyDALh0i',
